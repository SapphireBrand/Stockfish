          ...
          if (newDepth == 2) {
              ...
              if (captureOrPromotion) // 42490 hits in bench
                  ...
                  if (PvNode) { // 14508 hits in bench
                      ...
                      else if (ss->history >= NonPvLoNonCutHistoryCutoff)
                  ...
                  else if (improving && !cutNode && lastHistory <= 0 && type_of(move) == NORMAL && !pos.see_ge(make_move(to_sq(move), from_sq(move))))
                      historyCutoff = -20000;       // 1 hit in bench
