...
const int paramReductionFactor[4] = { 1932, 1929, 1964, 1941, };
const int paramFutilityConstant[4] = { 2406, 5000, 5000, 4980, };
const int paramFutilityPowMultipier[4] = { 739, 991, 986, 1012, };
const int paramFutilityPowExponent[4] = { 1808, 1981, 1981, 2020, };
