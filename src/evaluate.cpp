...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score ComplexityPawnCount         = S(9, 12);
  constexpr Score ComplexityOutflanking       = S(9, 8);
  constexpr Score ComplexityPawnsOnBothFlanks = S(19, 19);
  constexpr Score ComplexityNoPieces          = S(54, 48);
  constexpr Score ComplexityUnwinnable        = S(37, 33);
  constexpr Score ComplexityConstant          = S(60, 93);
