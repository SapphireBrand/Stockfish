...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score ComplexityOutflanking       = S(9, 10);
  constexpr Score ComplexityPawnsOnBothFlanks = S(18, 18);
  constexpr Score ComplexityNoPieces          = S(50, 49);
  constexpr Score ComplexityUnwinnable        = S(34, 32);
  constexpr Score ComplexityConstant          = S(59, 100);
